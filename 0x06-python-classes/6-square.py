...
class Square:
    def __init__(self, size=0, position=(0, 0)):
        """INIitialice a new square

        Args:
           size int : The size for  the new square
           position (int, int): the position for the new square.
        """
        self.size =  size
    ...
    @property
    def position(self):
        """Getter  and setter current position of the square"""
